...
Description : 
    SVM is one of our baseline baseline machine learning models for the Speech
    ...
    training a SVM classifier (linear kernel), and evaluating using
...
def main():
    ...
    predictAndEvaluate(svm_model, X_test_scaled, y_test, class_names=class_names)
